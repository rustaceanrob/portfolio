...
const Academics = (props: Props) => {
  return (
    <div className='flex flex-col justify-center items-center w-full'>
        <motion.div className='flex flex-col justify-start border-neutral-200 border rounded-md dark:bg-gray-950 bg-white px-8 py-8 md:px-10 md:py-10'
            ...
            <a href="" className='flex flex-row justify-start items-center pt-5 cursor-pointer hover:animate-pulse'>
                <BsLink45Deg size={18}/>
                <h1 className='pl-2 text-sm font-semibold'>The Bitcoin Standard</h1>
            </a>
            <a href="" className='flex flex-row justify-start items-center pt-2 cursor-pointer hover:animate-pulse'>
                <BsLink45Deg size={18}/>
